...
public class TemplateLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"JINJA_BLOCK_START", "JINJA_VAR_START", "JINJA_COMMENT_START", "HTML_OPEN", 
			"HTML_CLOSE", "HTML_SELF_CLOSE", "DOCTYPE", "HTML_TEXT", "HTML_WS", "JINJA_BLOCK_END", 
