...
public class CSSLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"AT_IMPORT", "AT_MEDIA", "AT_KEYFRAMES", "HASH", "CLASS", "PSEUDO", "IMPORTANT", 
			"LBRACE", "RBRACE", "LPAREN", "RPAREN", "LBRACK", "RBRACK", "SEMICOLON", 
			"COLON", "COMMA", "GT", "PLUS", "TILDE", "STAR", "STRING", "NUMBER", 
			"UNIT", "COLOR_HEX", "IDENT", "URL", "WS", "COMMENT"
		};
	}
