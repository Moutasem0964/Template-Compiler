...
public class PythonSubsetLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"NEWLINE", "WS", "IMPORT", "FROM", "GLOBAL", "DEF", "IF", "ELIF", "ELSE", 
			"FOR", "IN", "RETURN", "TRUE", "FALSE", "CLASS", "AT", "EQ", "EQEQ", 
			"LT", "GT", "LTEQ", "GTEQ", "PLUS", "MINUS", "STAR", "SLASH", "LPAREN", 
			"RPAREN", "LBRACK", "RBRACK", "LBRACE", "RBRACE", "COLON", "DOT", "COMMA", 
			"NUMBER", "STRING", "NAME", "COMMENT", "INDENT", "DEDENT"
		};
	}
