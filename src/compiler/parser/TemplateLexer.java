...
public class TemplateLexer extends Lexer {
	...
	public static final int
		JINJA_MODE=1, TAG_MODE=2, COMMENT_MODE=3;
	public static String[] channelNames = {
		"DEFAULT_TOKEN_CHANNEL", "HIDDEN"
	};

	public static String[] modeNames = {
		"DEFAULT_MODE", "JINJA_MODE", "TAG_MODE", "COMMENT_MODE"
	};

	private static String[] makeRuleNames() {
		return new String[] {
			"JINJA_BLOCK_START", "JINJA_VAR_START", "JINJA_COMMENT_START", "HTML_COMMENT", 
			"HTML_OPEN", "HTML_CLOSE", "DOCTYPE", "HTML_TEXT", "HTML_WS", "JINJA_BLOCK_END", 
			"JINJA_VAR_END", "FOR", "IN", "IF", "ELIF", "ELSE", "ENDIF", "ENDFOR", 
			"DOT", "LPAREN", "RPAREN", "LBRACK", "RBRACK", "COMMA", "EQUAL", "PIPE", 
			"JINJA_STRING", "JINJA_NUMBER", "JINJA_NAME", "JINJA_WS", "TAG_CLOSE", 
			"TAG_SLASH_CLOSE", "TAG_EQUALS", "TAG_NAME", "TAG_VALUE", "TAG_JINJA_VAR_START", 
			"TAG_WS", "JINJA_COMMENT_END", "JINJA_COMMENT_TEXT"
		};
	}
